...
class DILCR(nn.Layer):
    def __init__(self, in_dim=[], encoder_dim=[], feature_dim=512, peculiar_dim=512, common_dim=512,
        ...
        self.cluster_layer = paddle.create_parameter([self.cluster_num, self.cluster_var_dim], dtype="float32",default_initializer=paddle.nn.initializer.KaimingNormal())
